    ...
    <div className="mx-auto max-w-6xl space-y-12 md:space-y-16">
      ...
      <section className="grid gap-8 xl:grid-cols-[minmax(0,1.02fr)_minmax(360px,0.98fr)] xl:items-start">
        <div className="space-y-6">
          <div className="grid gap-5 md:grid-cols-[minmax(0,1.04fr)_minmax(0,0.76fr)] md:items-start xl:grid-cols-[minmax(0,0.96fr)_minmax(0,0.64fr)]">
            <div className="min-w-0 max-w-2xl">
              <SectionEyebrow>Vagas abertas</SectionEyebrow>
              <h2 className="mt-3 text-[2.15rem] leading-[0.94] font-semibold text-slate-950 md:text-[2.75rem] xl:text-[3rem]">
                Oportunidades para crescer com a equipe.
              </h2>
            </div>

            <p className="min-w-0 max-w-lg text-sm leading-7 text-slate-600 md:self-end md:text-base md:leading-8 md:justify-self-end">
